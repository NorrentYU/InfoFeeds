...
import { parseFeedXml } from "../../src/others/rss.js";

describe("others rss parser", () => {
  it("extracts content with priority content:encoded > description", () => {
    ...
    <rss version="2.0" xmlns:content="http://purl.org/rss/1.0/modules/content/">
      <channel>
        <item>
          <guid>g-1</guid>
          <title>Post A</title>
          <link>https://every.to/chain-of-thought/p/post-a?utm_source=tg</link>
    ...
    const parsed = parseFeedXml({
      sourceUrl: "https://every.to/chain-of-thought",
      feedUrl: "https://every.to/chain-of-thought/feed",
      xml,
      maxItems: 10,
    });
    ...
    expect(parsed.entries[0]?.link).toBe("https://every.to/chain-of-thought/p/post-a");
